    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notify_type', models.CharField(choices=[('add-new-folder', 'Add New Folder'), ('add-new-feature', 'Add New Feature'), ('promotional-campaign', 'Promotional Campaign'), ('pre-order', 'Pre Order'), ('event', 'Event'), ('update-content', 'Update Content'), ('login-reminder', 'Login Reminder')], max_length=60)),
